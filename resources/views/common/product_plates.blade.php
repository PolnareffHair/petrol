<div class="products">
    ...
    <div class="product_item">
        <div class="product_item_inside_block">
            ...
            <a href="product/{{$value["product_url_".$page_options["lang"]] }}"
                @else
                <a href="ua/product/{{$value["product_url_".$page_options["lang"]] }}" @endif
            ...
            @if(!isset($header_data['cart'][$value["product_id"]]))
